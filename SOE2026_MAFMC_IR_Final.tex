...
\caption{Mid-Atlantic region Total Vulnerability of commercial landings (sum of Mid-Atlantic port landings weighted by species climate vulnerability from the "=HYPERLINK(""https://www.fisheries.noaa.gov/national/climate-change/climate-vulnerability-assessments"",""Climate Vulnerability Assessment"")". Horizontal colored bars show different environmental variability risk levels. }\label{fig:climatevul-land}
\end{figure}
...
\caption{Mid-Atlantic region total vulnerability of commercial revenue (sum of Mid-Atlantic port revenue weighted by species climate vulnerability from the [Climate Vulnerability Assessment](https://www.fisheries.noaa.gov/national/climate-change/climate-vulnerability-assessments)). Horizontal colored bars show different
...
Ocean temperatures influence the distribution, seasonal timing, and productivity of managed species (see sections below). The Northeast US shelf, including the Mid-Atlantic, has experienced a continued warming trend for both the \href{https://noaa-edab.github.io/catalog/long_term_sst.html}{long term annual sea surface} (Fig. ef\{fig:long-term-sst\}) and \href{https://noaa-edab.github.io/catalog/seasonal_oisst_anom.html}{seasonal surface} (Fig. ef\{fig:seasonal-oisst-anom\}) and \href{https://noaa-edab.github.io/catalog/bottom_temp_model_anom.html}{bottom temperature} (Figs. ef\{fig:bottom-temp-anom\}, ef\{fig:bottom-temp-insitu\}). However, 2025 surface and bottom temperatures were near normal to cooler than normal conditions in all seasons in the MAB (see also the \hyperref[highlights]{2025 Highlights section}).
...
\caption{Seasonal Optimum Interpolation Sea Surface Temperature (OISST) anomaly by season for the Mid-Atlantic Bight, with long-term increasing trends (orange).}\label{fig:seasonal-oisst-anom}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth,]{images/MidAtlantic/productivity_anomaly_MidAtlantic_2026-03-18} 
