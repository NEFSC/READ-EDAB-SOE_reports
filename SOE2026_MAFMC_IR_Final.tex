...
\caption{Mid-Atlantic region Total Vulnerability of commercial landings (sum of Mid-Atlantic port landings weighted by species climate vulnerability from the Climate Vulnerability Assessment. Horizontal colored bars show different environmental variability risk levels. }\label{fig:climatevul-land}
\end{figure}
...
\caption{Mid-Atlantic region total vulnerability of commercial revenue (sum of Mid-Atlantic port revenue weighted by species climate vulnerability from the Climate Vulnerability Assessment. Horizontal colored bars show different
