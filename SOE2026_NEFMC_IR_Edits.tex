...
\caption{New England region total vulnerability of commercial landings (sum of New England port landings weighted by species climate vulnerability from the Climate Vulnerability Assessment.  Horizontal colored bars show different climate risk levels.}\label{fig:climatevul-land}
\end{figure}
...
\caption{New England region total vulnerability of commercial revenue (sum of New England port revenue weighted by species climate vulnerability from the Climate Vulnerability Assessment. Horizontal colored bars show different climate risk levels.}\label{fig:climatevul-rev-ne}
\end{figure}
