...
\fancyheadinit{%
   \ifthenelse{\value{page}=6}%
      {\fancyhead[R]{\includegraphics[width=40pt]{images/NOAA_logo.png} \\ \textsf{\emph{March 18, 2026}}}
       \fancyhead[L]{\textsf{\LARGE State of the Ecosystem 2026: New England}}
      }%
      {\fancyhead[R]{}
       \fancyhead[L]{\textsf{\emph{State of the Ecosystem 2026: New England}}}
      }
}
...
\caption{New England region total vulnerability of commercial landings (sum of New England port landings weighted by species climate vulnerability from Hare et al. 2016). Horizontal colored bars show different climate risk levels. There is a significant long-term trend (orange).}\label{fig:climatevul-land}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth,]{images/BothReports/harborporpoise_BothReports_2026-03-18} 
...
{\centering \includegraphics[width=1\linewidth,]{images/BothReports/grayseal_BothReports_2026-03-18} 

}

\caption{Gray seal five-year average bycatch estimate for New England and Mid-Atlantic U.S. gillnet fisheries (blue, with confidence interval shaded) and the potential U.S. biological removal (red). The range-wide Potential Biological Removal, including both U.S. and Canadian portions of the population, is 12,052 in the draft 2024 stock assessment report. The dashed line (black) represents the annual estimated bycatch.}\label{fig:grayseal}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth,]{images/BothReports/narw_abundance_BothReports_2026-03-18} 
...
{\centering \includegraphics[width=1\linewidth,]{images/BothReports/narw_calves_BothReports_2026-03-18} 
...
{\centering \includegraphics[width=1\linewidth,]{images/BothReports/seal_pups_BothReports_2026-03-18} 
...
{\centering \includegraphics[width=1\linewidth,]{images/BothReports/species_dist_BothReports_2026-03-18} 
...
{\centering \includegraphics[width=1\linewidth,]{images/BothReports/cetacean_dist_BothReports_2026-03-18} 
...
Mobile populations shift distributions to maintain suitable habitat and prey fields, possibly expanding ranges if new suitable habitat exists. Changes in managed species distribution is partially related to the \href{https://noaa-edab.github.io/catalog/forage_index.html}{distribution of forage biomass}. Since 1982, the fall center of gravity of forage fish (20 species combined) has moved to the north and east (Fig. \ref{fig:forageshifts}). Spring forage fish center of gravity has moved northward but without an eastward trend. Some of the whale and dolphin distribution shifts (Fig. \ref{fig:protectedspp-dist-shifts}) are likely in response to these forage fish shifts. \href{https://noaa-edab.github.io/catalog/zooplankton_index.html\#key-results-and-visualizations-4}{Small copepods}, widespread prey of many larval and juvenile fish, show a similar shift in center of gravity as forage fish, to the north and east in the fall, as well as northward in spring (Fig. \ref{fig:calfin-cog}).

\begin{figure}[!htbp]

{\centering \includegraphics[width=1\linewidth,]{images/NewEngland/calfin_cog_NewEngland_2026-03-18} 
...
{\centering \includegraphics[width=1\linewidth,]{images/BothReports/forage_dist_BothReports_2026-03-18} 
...
{\centering \includegraphics[width=1\linewidth,]{images/BothReports/megabenthos_dist_BothReports_2026-03-18} 
...
{\centering \includegraphics[width=1\linewidth,]{images/BothReports/macrobenthos_dist_BothReports_2026-03-18} 
...
{\centering \includegraphics[width=1\linewidth,]{images/BothReports/lgcopeall_cog_BothReports_2026-03-18} 
...
{\centering \includegraphics[width=1\linewidth,]{images/BothReports/smallcopeall_cog_BothReports_2026-03-18} 
...
{\centering \includegraphics[width=1\linewidth,]{images/BothReports/euph_cog_BothReports_2026-03-18} 
...
Ocean temperatures influence the distribution, seasonal timing, and productivity of managed species (see sections below). The Northeast US shelf, including New England, has experienced a continued warming trend for the \href{https://noaa-edab.github.io/catalog/long_term_sst.html}{long term annual sea surface} (Fig. \ref{fig:long-term-sst}). GB and the GOM have experienced a seasonal warming trend for surface waters in all seasons but winter (\ref{fig:seasonal-oisst-anom}). Bottom temperature has also been increasing in GB (winter and spring) and in the GOM (spring and summer) (Figs. \ref{fig:bottom-temp-anom}, \ref{fig:bottom-temp-insitu}). However, 2025 observations show cooler to average sea surface temperature in all seasons in GB and all seasons but summer in the GOM. Bottom temperature in 2025 has stayed near or below average in all seasons across New England. See the \hyperref[highlights]{2025 Highlights section} for the recent events linked to these cooler conditions.

\begin{figure}[!htbp]

{\centering \includegraphics[width=1\linewidth,]{images/NewEngland/seasonal_oisst_anom_NewEngland_2026-03-18} 
...
{\centering \includegraphics[width=1\linewidth,]{images/NewEngland/bottom_temp_anom_NewEngland_2026-03-18} 
...
{\centering \includegraphics[width=1\linewidth,]{images/BothReports/long_term_sst_BothReports_2026-03-18} 
...
{\centering \includegraphics[width=1\linewidth,]{images/BothReports/west_gsi_BothReports_2026-03-18} 
...
{\centering \includegraphics[width=1\linewidth,]{images/BothReports/cold_pool_BothReports_2026-03-18} 
...
{\centering \includegraphics[width=1\linewidth,]{images/BothReports/spawn_timing_BothReports_2026-03-18} 
...
{\centering \includegraphics[width=1\linewidth,]{images/BothReports/cold_pool_time_BothReports_2026-03-18} 
...
{\centering \includegraphics[width=1\linewidth,]{images/NewEngland/productivity_anomaly_NewEngland_2026-03-18} 
...
{\centering \includegraphics[width=1\linewidth,]{images/BothReports/slopewater_BothReports_2026-03-18} 
