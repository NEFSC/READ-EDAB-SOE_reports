...
\caption{New England region total vulnerability of commercial landings (sum of New England port landings weighted by species climate vulnerability from the [Climate Vulnerability Assessment](https://www.fisheries.noaa.gov/national/climate-change/climate-vulnerability-assessments)). Horizontal colored bars show different climate risk levels.}\label{fig:climatevul-land}
\end{figure}
