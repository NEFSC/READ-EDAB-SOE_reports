...
{\centering \includegraphics[width=1\linewidth,]{C:/Users/stephanie.owen/Documents/READ-EDAB-SOE_reports/SOE2026_NEFMC_IR_Edits_files/figure-latex/docformat-1} 
...
\caption{Total commercial landings (black) and New England Fishery Management Council managed U.S seafood landings (red) by feeding guild for the Gulf of Maine (GOM, right) and Georges Bank (GB, left), with significant long-term declines (purple).}\label{fig:comm-landings}
\end{figure}
...
\caption{New England region total vulnerability of commercial landings (sum of New England port landings weighted by species climate vulnerability from the "=HYPERLINK(""https://www.fisheries.noaa.gov/national/climate-change/climate-vulnerability-assessments"";""Climate Vulnerability Assessment"")".  Horizontal colored bars show different climate risk levels.}\label{fig:climatevul-land}
\end{figure}
...
\caption{New England region total vulnerability of commercial revenue (sum of New England port revenue weighted by species climate vulnerability from the [Climate Vulnerability Assessment](https://www.fisheries.noaa.gov/national/climate-change/climate-vulnerability-assessments). Horizontal colored bars show different climate risk levels.}\label{fig:climatevul-rev-ne}
\end{figure}
...
\caption{Estimated number of gray seal pups born at four United States pupping colonies at various times from 1988 to 2021. }\label{fig:seals}
\end{figure}
...
\caption{Seasonal Optimum Interpolation Sea Surface Temperature (OISST) anomaly by season for the Gulf of Maine (GOM, top) and Georges Bank (GB, bottom), with long-term increasing trends (orange).}\label{fig:seasonal-oisst-anom}
\end{figure}
...
\caption{Annual in situ bottom temperature anomaly for Georges Bank (GB, top) and the Gulf of Maine (GOM, bottom), with long-term increasing trends (orange).}\label{fig:bottom-temp-insitu}
\end{figure}
...
\caption{GLORYS (black) and debiased Regional Ocean Modeling System (ROMS) (red) seasonal bottom temperature anomaly for the Gulf of Maine (GOM, top) and Georges Bank (GB, bottom), with long-term increasing trends (orange).}\label{fig:bottom-temp-anom}
\end{figure}
...
\caption{Ocean summer length in New England (Georges Bank (GB), top; Gulf of Maine (GOM), bottom): the annual total number of days between the spring thermal transition date and the fall thermal transition date (black), with a long-term increasing trend (orange). Transition dates are based on sea surface temperatures.}\label{fig:transition}
\end{figure}
...
\caption{Percent of port revenue from wind lease areas for Mid-Atlantic ports that land a majority of New England Fishery Management Council-managed species within the wind lease areas. Percent of revenue is shown for leases not under construction (blue) and active leases (orange).}\label{fig:wind-rev}
\end{figure}
