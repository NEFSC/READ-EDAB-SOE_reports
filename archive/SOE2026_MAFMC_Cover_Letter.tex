...
\usepackage[left=2cm, right=2cm, top=3.5cm, bottom=2cm, footskip =
.5cm]{geometry}
\usepackage[unicode=true]{hyperref}
\PassOptionsToPackage{usenames,dvipsnames}{color} % color is loaded by hyperref
\hypersetup{
            pdfauthor={Abigail Tyrell, PhD; Research Fishery Biologist; Ecosystem Dynamics and Assessment Branch; Northeast Fisheries Science Center},
            colorlinks=true,
            linkcolor=Maroon,
            citecolor=Blue,
            urlcolor=blue,
...
\signature{\vspace*{-8ex}\includegraphics{C:/Users/abigail.tyrell/Documents/code/READ-EDAB-SOE\_reports/utils/signature\_tyrell.jpg}\\Abigail
Tyrell, PhD\\Research Fishery Biologist\\Ecosystem Dynamics and
...
\begin{letter}{Mid-Atlantic Fishery Management Council\\800 N. State
St., Suite 201\\Dover, DE 19901}
\opening{To the SSC,}
...
\longindentation=0pt
\closing{Sincerely,}
\encl{State of the Ecosystem 2026: Request Tracking Memo}
\cc{Jon Hare}
