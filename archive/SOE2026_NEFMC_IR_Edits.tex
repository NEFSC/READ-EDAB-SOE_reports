...
\caption{New England region total vulnerability of commercial landings (sum of New England port landings weighted by species vulnerability scores).  Horizontal colored bars show different environmental variability risk levels.}\label{fig:climatevul-land}
\end{figure}
