...
\caption{Mid-Atlantic region Total Vulnerability of commercial landings (sum of Mid-Atlantic port landings weighted by species climate vulnerability from Hare et al. 2016), with long-term increasing trend (orange). Horizontal colored bars show different environmental variability risk levels.
...
{\centering \includegraphics[width=1\linewidth]{images/NewEngland/slide_rec_hms_NewEngland_2026-01-20} 
...
{\centering \includegraphics[width=1\linewidth]{images/MidAtlantic/functional_traits_MidAtlantic_2026-01-21} 
...
\begin{center}\includegraphics[width=1\linewidth]{images/BothReports/energy_density_BothReports_2026-01-09} \end{center}
...
\caption{Changes in abundance anomalies for in the MAB for large (top) and small (middle) copepods, and Euphausiids (bottom), with significant decreases (short-term, dark purple; long-term, light purple) in small copepods and and long-term increases (orange) in Euphausiids.}\label{fig:zoopanom-ne}
\end{figure}
...
\caption{Locations where bottom aragonite saturation state ($\Omega_{Arag}$; summer only: June-August) were at or below the laboratory-derived sensitivity level for Atlantic sea scallop (left panel) and longfin squid (right panel) for the time periods 2007-2022 (dark cyan), 2023 only (magenta) and 2024 only (cyan). Gray circles indicate locations where bottom $\Omega_{Arag}$ values were above the species specific sensitivity values..}\label{fig:mab-oa-219}
\end{figure}
...
\caption{Percent of New England port fisheries revenue from Wind Energy Areas (WEA) from all leases (active + non-active; green), non-active leases (blue), and active leases (orange).}\label{fig:wea-port-rev-251}
\end{figure}
...
\caption{Percent of New England port revenue with majority MAFMC landings from Wind Energy Areas (WEA) from all leases (green), leases not under construction (blue), and active leases (orange). }\label{fig:wind-rev-252}
\end{figure}
