...
\caption{Mid-Atlantic region total climate vulnerability of commercial landings (sum of Mid-Atlantic port landings weighted by species climate vulnerability from Hare et al. 2016). Horizontal colored bars show different
...
\caption{Recreational shark landings in the New England region from NOAA Fisheries' Large Pelagics Survey (top) and Marine Recreational Information Program (bottom).}\label{fig:rec-hms-64}
\end{figure}
...
\caption{Species revenue diversity (permit-level species effective Shannon index) in New England, with short-term declining trend (dark purple).}\label{fig:permit-div}
\end{figure}
...
\caption{Zooplankton diversity on Georges Bank and in the Gulf of Maine, based on Shannon diversity index. 2020 surveys were incomplete due to COVID-19.}\label{fig:zoo-diversity-ne}
\end{figure}
...
\caption{Fish community functional traits in New England based on Fall (red) and Spring (blue) survey data for Georges Bank (GB, top) and the Gulf of Maine (bottom). Dashed lines represent the long term annual mean. }\label{fig:traits-ne}
\end{figure}
...
\caption{Eastward (top) and northward (bottom) shifts in the center of gravity for 20 forage fish species on the Northeast U.S. Shelf in fall (left) and spring (right), with increasing trend (orange) for fall eastward and northward center of gravity.}\label{fig:forageshifts}
\end{figure}
...
\caption{Eastward (top) and northward (bottom) shifts in the center of gravity for macrobenthos species on the Northeast U.S. Shelf in fall (left) and spring (right).}\label{fig:macrobenthosshifts}
\end{figure}
...
\caption{The Mid Atlantic Bight Cold Pool persistence index based on bias-corrected ROMS-NWA (open circles) and GLORYS (closed circles).}\label{fig:cold-pool-time-ne}
\end{figure}
...
\caption{Monthly median chlorophyll a concentration time series for Georges Bank (top) and Gulf of Maine (bottom). Significant positive trends (orange lines) in fall and early winter are based on a 26 year time series.}\label{fig:chl-month-ne}
\end{figure}
...
\caption{Common tern productivity - the number of fledged chicks per nest - at seven Gulf of Maine colonies managed by the National Audubon Society's Seabird Restoration Program. }\label{fig:seabird-ne-productivity}
\end{figure}
...
\caption{Percent return rate (top) and abundance (bottom) of Atlantic salmon returns to Gulf of Maine rivers since 1972 and return rates for two sea winter returns from hatchery smolt stocking in the Penobscot River. Long-term decreasing trend in purple.}\label{fig:salmon}
\end{figure}
...
\caption{Forage fish index in GB (top) and GOM (bottom) for spring (blue) and fall (red) surveys. Index values are relative to the maximum observation within a region across surveys.}\label{fig:foragebio-ne}
\end{figure}
