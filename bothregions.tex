...
\caption{Total commercial landings (black), total U.S. seafood landings (blue), and New England managed U.S. seafood landings (red) for Georges Bank (GB, top) and the Gulf of Maine (GOM, bottom),  with significant decline (purple) in total landings.}\label{fig:total-landings-62}
\end{figure}
...
\caption{Total commercial landings (black) and NEFMC managed U.S seafood landings (red) by feeding guild for the Gulf of Maine (GOM, right) and Georges Bank (GB, left), with significant long-term declines (purple).}\label{fig:comm-landings-63}
\end{figure}
...
\caption{New England region total climate vulnerability of commercial landings (sum of New England port landings weighted by species climate vulnerability from Hare et al. 2016). Horizontal colored bars show different climate risk levels.}\label{fig:climatevul-land-64}
\end{figure}
...
\caption{Total recreational seafood harvest (millions of pounds, black, significant decrease, purple) in the New England region.}\label{fig:rec-landings-65}
\end{figure}
...
\caption{Recreational shark landings in the New England region from NOAA Fisheries' Large Pelagics Survey (top) and Marine Recreational Information Program (bottom), with declining trends (purple).}\label{fig:rec-hms-66}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{images/MidAtlantic/slide_zoo_diversity_MidAtlantic_2026-01-12} 
...
{\centering \includegraphics[width=1\linewidth]{images/MidAtlantic/slide_traits_MidAtlantic_2026-01-12} 
...
{\centering \includegraphics[width=1\linewidth]{images/NewEngland/slide_totpp_NewEngland_2026-01-12} 
...
{\centering \includegraphics[width=1\linewidth]{images/NewEngland/slide_zoo_diversity_NewEngland_2026-01-12} 
...
{\centering \includegraphics[width=1\linewidth]{images/NewEngland/slide_traits_NewEngland_2026-01-12} 
...
{\centering \includegraphics[width=1\linewidth]{images/BothReports/slide_species_dist_BothReports_2026-01-12} 
...
{\centering \includegraphics[width=1\linewidth]{images/BothReports/slide_spawn_timing_BothReports_2026-01-12} 
...
{\centering \includegraphics[width=1\linewidth]{images/MidAtlantic/slide_transition_date_MidAtlantic_2026-01-12} 
...
{\centering \includegraphics[width=1\linewidth]{images/NewEngland/slide_transition_date_NewEngland_2026-01-12} 
...
{\centering \includegraphics[width=1\linewidth]{images/MidAtlantic/slide_zooplankton_anomaly_MidAtlantic_2026-01-12} 
...
{\centering \includegraphics[width=1\linewidth]{images/BothReports/slide_therm_hab_persist_BothReports_2026-01-12} 
...
\caption{Energy density (mean and standard deviation) of eight forage species from NEFSC bottom trawl surveys by season and year, compared with limited data available from the 1980s (solid line; Steimle and Terranove 1985) and 1990s (dashed line; Lawson et al. 1998) values.}\label{fig:energy-density-221}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{images/NewEngland/slide_zooplankton_anomaly_NewEngland_2026-01-12} 
...
\caption{Locations where bottom aragonite saturation state ($\Omega_{Arag}$; summer only: June-August) were at or below the laboratory-derived sensitivity level for Atlantic sea scallop (left panel) and longfin squid (right panel) for the time periods 2007-2022 (dark cyan), 2023 only (magenta) and 2024 only (cyan). Gray circles indicate locations where bottom $\Omega_{Arag}$ values were above the species specific sensitivity values..}\label{fig:mab-oa-222}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{images/MidAtlantic/slide_wind_revenue_MidAtlantic_2026-01-12} 
...
\includegraphics[width=1\linewidth]{images/MidAtlantic/slide_wea_port_rev_MidAtlantic_2026-01-12} \hfill{}

\caption{Percent of Mid-Atlantic port revenue from Wind Energy Areas (WEA) from all leases (active + non-active; green), non-active leases (blue), and active leases (orange). Note that North Carolina fisheries management is split between the Northeast and Southeast, and this plot only includes data reported to the Northeast Fisheries Science Center. }\label{fig:wea-port-rev}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{images/NewEngland/slide_wind_revenue_NewEngland_2026-01-12} 
...
\includegraphics[width=1\linewidth]{images/NewEngland/slide_wea_port_rev_NewEngland_2026-01-12} \hfill{}

\caption{Percent of New England port fisheries revenue from Wind Energy Areas (WEA) from all leases (active + non-active; green), non-active leases (blue), and active leases (orange).}\label{fig:wea-port-rev-254}
\end{figure}
...
\caption{Percent of Mid-Atlantic port revenue with majority NEFMC landings from Wind Energy Areas (WEA) from all leases (green), leases not under construction (blue), and leases under construction or operational (orange). }\label{fig:wind-rev-255}
\end{figure}
