...
\begin{center}\includegraphics[width=1\linewidth]{images/BothReports/energy_density_BothReports_2025-10-31} \end{center}
...
\caption{Percent of New England port revenue with majority MAFMC landings from Wind Energy Areas (WEA) from all leases (active + non-active; green), non-active leases (blue), and active leases (orange). }\label{fig:wind-rev}
\end{figure}
...
\caption{Percent of Mid-Atlantic port revenue with majority NEFMC landings from Wind Energy Areas (WEA) from all leases (active + non-active; green), non-active leases (blue), and active leases (orange).}\label{fig:wind-rev-253}
\end{figure}
