...
```{r rec-hms, fig.cap=return_caption(chunk_name = "rec-hms"), fig.width=8, fig.asp=.35}
```
...
```{r stock-status, fig.width = 7.5,  fig.asp = 0.5, fig.cap = return_caption(chunk_name = "stock-status")}
...
```{r abcacl-stacked, fig.cap=return_caption(chunk_name = "abcacl-stacked"), fig.width = 6, fig.asp = 0.4}
```
...
```{r nefsc-biomass-mab, fig.cap =  return_caption(chunk_name = "nefsc-biomass-mab"), fig.width=8, fig.asp = 0.75, results='hide'}
