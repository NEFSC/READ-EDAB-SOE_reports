...
```{r comm-revenue, fig.width = 6.5, fig.cap = return_caption(chunk_name = "comm-revenue", region = "NewEngland")}
...
```{r bennet, fig.cap = return_caption(chunk_name = "bennet", region = "NewEngland"), fig.width = 6.5, fig.asp = 0.4}
return_plot("bennet", region = "NewEngland")
```

```{r bennet-all, fig.cap = return_caption(chunk_name = "bennet-all", region = "NewEngland"), fig.width = 6.5, fig.asp = 0.65}
...
```{r, comm-clim-rev, fig.cap = return_caption(chunk_name = "climatevul-rev", region = "NewEngland"), fig.width=6.5, fig.asp=0.5}
