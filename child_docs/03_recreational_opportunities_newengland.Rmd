...
```{r rec-op, fig.cap = return_caption(chunk_name = "rec-op", region = "NewEngland"),fig.width = 6.5,fig.asp = 0.3}
return_plot("rec-op", region = "NewEngland")
```

```{r rec-div, fig.cap = return_caption(chunk_name = "rec-div", region = "NewEngland"),fig.width = 6.5,fig.asp = 0.3}
