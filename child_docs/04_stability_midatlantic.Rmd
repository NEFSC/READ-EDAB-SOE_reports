...
```{r comm-div-fleet, fig.width = 7.5, fig.asp = 0.3, fig.cap=return_caption(chunk_name = "comm-div-fleet")}
```
...
ecodata::plot_annual_chl_pp(report = params$region, varName = "pp", plottype = "total", EPU = "MAB") +
