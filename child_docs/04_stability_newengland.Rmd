...
```{r recdat-div-catch,  fig.cap = return_caption(chunk_name = "recdat-div-catch", region = "NewEngland"),fig.width = 6.5,fig.asp = 0.3}
...
```{r totpp, fig.cap =return_caption(chunk_name = "totpp", region = "NewEngland"),fig.width = 7.5,fig.asp = 0.3}
...
```{r zoo-diversity, fig.cap = return_caption(chunk_name = "zoo-diversity", region = "NewEngland"), fig.width = 6.5, fig.asp = 0.3}
return_plot("zoo-diversity", region = "NewEngland")
```

```{r exp-n, fig.cap = return_caption(chunk_name = "exp-n", region = "NewEngland"),fig.width = 6.5,fig.asp = 0.3}
...
```{r traits, fig.cap = return_caption(chunk_name = "traits", region = "NewEngland"),fig.width = 6.5,fig.asp = 0.3}
