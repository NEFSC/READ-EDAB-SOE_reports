...
```{r commercial-engagement-1, fig.cap= return_caption(chunk_name = "commercial-engagement"), fig.width = 7, fig.asp = 0.85, results='hide'}
a + ggplot2::theme(plot.title=element_text(vjust = 0))
```


```{r comvultab}
## TODO: this can probably be moved to child_plots.Rmd
...
t <- ecodata::plot_engagement(varName = "Commercial", plottype = "Social")
t |>
...
```{r recreational-engagement-1, fig.cap= return_caption(chunk_name = "recreational-engagement"), fig.width = 7, fig.asp = 0.85, results='hide'}
a + ggplot2::theme(plot.title=element_text(vjust = 0))
```
