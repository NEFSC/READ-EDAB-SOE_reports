...
```{r commercial-engagement, fig.cap= return_caption(chunk_name = "commercial-engagement"), fig.width = 7, fig.asp = 0.85, results='hide'}
...
```{r recreational-engagement, fig.cap= return_caption(chunk_name = "recreational-engagement"), fig.width = 7, fig.asp = 0.85, results='hide'}
