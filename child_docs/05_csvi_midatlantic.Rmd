...
```{r commercial-engagement-2, fig.cap= return_caption(chunk_name = "commercial-engagement"), fig.width = 7, fig.asp = 0.85, results='hide'}
...
```{r recreational-engagement-2, fig.cap= return_caption(chunk_name = "recreational-engagement"), fig.width = 7, fig.asp = 0.85, results='hide'}
a + ggplot2::theme(plot.title=element_text(vjust = 0))
```
