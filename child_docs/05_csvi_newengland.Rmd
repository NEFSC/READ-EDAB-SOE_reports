...
```{r commercial-engagement, fig.cap= return_caption(chunk_name = "commercial-engagement", region = "NewEngland"), fig.width = 7, fig.asp = 0.5}
...
\newpage
```{r recreational-engagement, fig.cap= return_caption(chunk_name = "recreational-engagement", region = "NewEngland"), fig.width = 6.5, fig.asp = 0.7}
...
```{r commvulex, fig.width = 6.5, fig.asp=.5, fig.cap=return_caption(chunk_name = "commvulex", region = "NewEngland")}
