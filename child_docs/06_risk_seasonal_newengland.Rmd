...
```{r cold-pool-time, fig.cap=return_caption(chunk_name = "cold-pool-time", region = "BothReports"), fig.width = 6.5, fig.asp=.3}
...
```{r chl-month, fig.cap=return_caption(chunk_name = "chl-month", region = "NewEngland"), fig.width =6.5, fig.height = 8}
