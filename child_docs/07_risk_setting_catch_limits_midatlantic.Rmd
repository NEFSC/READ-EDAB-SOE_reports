...
```{r therm-hab-persist-2024, fig.cap = return_caption(chunk_name = "therm-hab-persist-2024", region = "MidAtlantic"), fig.width=6.5, fig.asp=.5}
return_plot("therm-hab-persist-2024", region = "MidAtlantic")
```
