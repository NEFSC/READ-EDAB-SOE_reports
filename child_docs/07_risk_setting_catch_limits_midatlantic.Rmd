...
```{r productivity-anomaly, fig.cap = return_caption(chunk_name = "productivity-anomaly"), fig.width=8, fig.asp=0.6}
```
...
```{r mab-cf, fig.cap = return_caption(chunk_name = "mab-cf"), fig.width=9, fig.asp=.7}
```
...
```{r energy-density, fig.cap=return_caption(chunk_name = "energy-density"),  fig.width = 7.5, fig.asp = 0.5}
```
...
```{r benthos, fig.cap=return_caption(chunk_name = "benthos"), fig.width=7.5, fig.asp=.4}
```
...
```{r zoopanom, fig.cap=return_caption(chunk_name = "zoopanom"), fig.width=7.5, fig.asp=.4}
```
...
```{r therm-hab-persist-2024, fig.cap = return_caption(chunk_name = "therm-hab-persist-2024"), fig.width=10, fig.asp=.5}
```

`r oa_paragraph`

```{r mab-oa, out.width = '100%', fig.cap = return_caption(chunk_name = "mab-oa")}
```
