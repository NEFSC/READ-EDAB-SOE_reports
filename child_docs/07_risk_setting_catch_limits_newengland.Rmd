...
```{r energy-density, fig.cap=return_caption(chunk_name = "energy-density", region = "NewEngland"),  fig.width = 6.5, fig.asp = 0.5}
...
```{r therm-hab-persist-2024-ne, fig.cap=return_caption(chunk_name = "therm-hab-persist-2024", region = "NewEngland"), fig.width=6.5, fig.asp=0.5}
return_plot("therm-hab-persist-2024", region = "NewEngland")
```
