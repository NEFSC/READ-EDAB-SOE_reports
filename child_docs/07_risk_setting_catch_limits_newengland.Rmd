...
knitr::include_graphics(here::here("images/Calanusfinmarchicus-JeffreyRunge_2025.png"))
```
...
```{r mab-oa-1, eval = TRUE, out.width = '100%', fig.cap = return_caption(chunk_name = "mab-oa")}
