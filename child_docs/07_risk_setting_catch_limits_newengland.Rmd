...
gb <- ecodata::plot_condition(report = params$region, EPU = "GB")

gom <- ecodata::plot_condition(report = params$region, EPU = "GOM")
...
knitr::include_graphics(cfin_image)
```
...
knitr::include_graphics(mab_oa_image)
```
