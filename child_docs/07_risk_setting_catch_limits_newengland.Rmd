...
```{r productivity-anomaly, fig.cap = return_caption(chunk_name = "productivity-anomaly", region = "NewEngland"), fig.width=6.5, fig.asp=1}
...
```{r foragebio, fig.cap = return_caption(chunk_name = "foragebio", region = "NewEngland"), fig.width = 6.5, fig.asp=.3}
...
```{r benthos, fig.cap=return_caption(chunk_name = "benthos", region = "NewEngland"), fig.width=6.5, fig.asp=.9}
...
```{r zoopanom, fig.cap=return_caption(chunk_name = "zoopanom", region = "NewEngland"), fig.width=6.5,fig.asp = 1}
...
```{r therm-hab-persist-2024, fig.cap=return_caption(chunk_name = "therm-hab-persist-2024", region = "BothReports"), fig.width=6.5, fig.asp=0.5}
