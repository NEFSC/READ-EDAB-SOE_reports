...
create_wea_landings_rev_table(council = "MAFMC") |>
  ...
  flextable::flextable() %>%
  flextable::set_caption("Top 10 Mid-Atlantic managed species Landings and Revenue from Wind Energy Areas. *Less than a maximum of 50,000 lb was reported landed annually in wind energy lease areas for these species.") %>%
