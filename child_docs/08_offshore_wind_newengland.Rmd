...
```{r wea-spp-rev, fig.cap=return_caption(chunk_name = "wea-spp-rev", region = "NewEngland"),  fig.width=6, fig.asp=.6}
...
```{r wind-rev, fig.cap=return_caption(chunk_name = "wind-rev", region = "NewEngland"), fig.width=6.5, fig.asp=.4, fig.align='left'}
