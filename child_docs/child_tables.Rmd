...
comm_vul_table <- ecodata::plot_community_factors(report = params$region, varName = "Social", plottype = "Commercial") |>
  flextable::flextable() |>
...
rec_vul_table <- ecodata::plot_community_factors(report = params$region, varName = "Social", plottype = "Recreational") |>
  flextable::flextable() |>
  flextable::set_header_labels(personal_disruption_rank = "Personal Disruption",
                               pop_composition_rank = "Population Composition",
                               poverty_rank = "Poverty") |>
