...
```{r bennet-all, fig.cap = return_caption(chunk_name = "bennet-all"),  fig.width = 7.5, fig.asp = 0.35}
```
...
```{r climatevul-rev, fig.width=8, fig.asp=0.5, fig.cap=return_caption(chunk_name = "climatevul-rev")}
```
