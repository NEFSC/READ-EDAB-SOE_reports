```{r management-objectives, ft.arraystretch = 1.5}
mng_obj <- data.frame(
...
mng_obj <- tibble::as.tibble(mng_obj)
...
```
<!-- \newpage -->
```{r management-risks, ft.arraystretch = 1.5}
mng_obj <- data.frame(
  "Risks" = c(
...
tab <- flextable::as_grouped_data(mng_obj, groups = "service") |>
  ...
  flextable::padding(padding.top = 10, padding.bottom = 10, part = "all")# |>
# flextable::autofit()
