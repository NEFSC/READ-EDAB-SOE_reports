...
\caption{Recreational shark landings in the New England region from NOAA Fisheries' Large Pelagics Survey (top) and Marine Recreational Information Program (bottom).}\label{fig:rec-hms}
\end{figure}
