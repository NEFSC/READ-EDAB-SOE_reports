...
```{r seals, fig.cap = return_caption(chunk_name = "seals"),fig.width = 7.5, fig.asp = 0.4, eval = params$region == "NewEngland"}
...
```{r species-dist, fig.cap = return_caption(chunk_name = "species-dist"), fig.width = 8, fig.asp=0.27}
...
```{r forageshifts, fig.cap=return_caption(chunk_name = "forageshifts"), fig.width = 8, fig.asp = .3}
...
```{r macrobenthosshifts, fig.cap=return_caption(chunk_name = "macrobenthosshifts"), fig.width = 8,fig.asp = .3}
## TODO: move these aesthetic updates into ecodata function
...
```{r GSI, fig.cap = fig.cap=return_caption(chunk_name = "GSI")}
...
```{r cold-pool-size, fig.cap=return_caption(chunk_name = "cold-pool-size"), fig.width = 7.5, fig.asp = 0.3, results='hide'}
...
```{r spawntiming, fig.cap=return_caption(chunk_name = "spawntiming"), fig.width = 7, fig.asp=.5}
