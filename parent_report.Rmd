...
return_plot("seasonal-oisst-anom", region = "MidAtlantic")
```

```{r bottom-temp-anom, fig.cap=return_caption(chunk_name = "bottom-temp-anom", region = "MidAtlantic")}
return_plot("bottom-temp-anom", region = "MidAtlantic")
```
...
```{r transition, fig.cap=return_caption(chunk_name = "transition", region = "MidAtlantic"), fig.width=6.5, fig.asp=0.3}
...
```{r transition-ne, fig.cap=return_caption(chunk_name = "transition", region = "NewEngland"), fig.width=6.5, fig.asp=0.3}
...
```{r slopesea-bottom, out.width="65%", fig.cap=return_caption(chunk_name = "slopesea-bottom", region = "BothReports")}
return_plot("slopesea-bottom", region = "BothReports")
```
...
```{r chl-anom-apr, fig.asp=.5, fig.cap=return_caption(chunk_name = "chl-anom-apr", region = "BothReports")}
return_plot("chl-anom-apr", region = "BothReports")
```

```{r chl-anom-oct, fig.asp=.5, fig.cap=return_caption(chunk_name = "chl-anom-oct", region = "BothReports")}
return_plot("chl-anom-oct", region = "BothReports")
```
...
```{r chesapeake-jan, fig.width = 2.5, fig.height = 4.5, fig.cap=return_caption(chunk_name = "chesapeake-jan", region = "BothReports")}
return_plot("chesapeake-jan", region = "BothReports")
```

```{r chesapeake-apr, fig.width = 2.5, fig.height = 4.5, fig.cap=return_caption(chunk_name = "chesapeake-apr", region = "BothReports")}
return_plot("chesapeake-apr", region = "BothReports")
```
