...
return_caption <- function(key = caption_key,
                           chunk_name,
                           region) {
  col <- dplyr::case_when(region == "MidAtlantic" ~ "fig_cap_ma",
...
return_filepath <- function(key = caption_key,
                           chunk_name,
                           region) {
  col <- dplyr::case_when(region == "MidAtlantic" ~ "fig_path_ma",
...
return_plot <- function(name, cap_key = caption_key, ...) {
...
```{r transition2, fig.cap=return_caption(chunk_name = "transition", region = opp_region)}
