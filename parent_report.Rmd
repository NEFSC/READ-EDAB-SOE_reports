...
`r if(params$region == "NewEngland") "\\setcounter{page}{6}"`
`r if(params$region == "MidAtlantic") "\\setcounter{page}{4}"`
...
The increasing trend in 5-year average gray seal bycatch may be related to an increase in the gray seal population ([U.S. pup counts](https://noaa-edab.github.io/catalog/seal_pups.html) `r if(params$region == "NewEngland") "; Fig. \\ref{fig:seals})"`, supported by the dramatic rise over the last three decades in observed numbers of gray seal pups born at U.S. breeding sites plus an increase in adult seals at the breeding sites, some of which are supplemented by Canadian adults.
...
Human interaction from entanglements or vessel strikes remains the primary cause of death in an ongoing North Atlantic right whale Unusual Mortality Event since 2017. Interactions between right whales and both the fixed gear fisheries in the U.S. and Canada and vessel strikes in the U.S. are contributing substantially to the decline of the species. [Recent research](https://noaa-edab.github.io/catalog/narw.html) suggests that climate-driven changes in ocean circulation and associated changes in the [primary right whale prey](https://noaa-edab.github.io/catalog/preyfield_energy.html) have caused right whale distribution changes in the Gulf of Maine. Additional potential stressors include [offshore wind development](#other-ocean-uses-offshore-wind).
...
<!-- \newpage -->
`r if(params$region == "MidAtlantic") "\\newpage"`
...
[Ocean acidification (OA)](https://noaa-edab.github.io/catalog/ocean_acidification.html) risk in 2025 in the Mid-Atlantic was relatively low (Fig. \ref{fig:mab-oa}). There were few locations in 2025 where OA risk was high for Atlantic sea scallops, longfin squid, and pteropods. This is in contrast to the more prevalent OA risk events for these species in 2023 and 2024. [Gulf of Maine surface OA risk](https://noaa-edab.github.io/catalog/gom_acidification.html) in 2025 was below 2024 levels, as indicated by aragonite saturation state (Ωa) at or near the climatological average (2006-2024).  
