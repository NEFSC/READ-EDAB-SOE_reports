...
```{r slopesea-bottom, out.width="65%", fig.cap=return_caption(chunk_name = "slopesea-bottom", region = "BothReports"),fig.height= 3}
return_plot("slopesea-bottom", region = "BothReports")
```

```{r slopesea, out.width="65%", fig.height = 3, fig.cap=return_caption(chunk_name = "slopesea", region = "BothReports")}
...
```{r chl-anom-apr, out.width="65%", fig.cap=return_caption(chunk_name = "chl-anom-apr", region = "BothReports")}
return_plot("chl-anom-apr", region = "BothReports")
```

```{r chl-anom-oct, out.width="65%", fig.cap=return_caption(chunk_name = "chl-anom-oct", region = "BothReports")}
...
```{r chesapeake-jan, out.width="30%", fig.cap=return_caption(chunk_name = "chesapeake-jan", region = "BothReports")}
return_plot("chesapeake-jan", region = "BothReports")
```

```{r chesapeake-apr, out.width="30%", fig.cap=return_caption(chunk_name = "chesapeake-apr", region = "BothReports")}
