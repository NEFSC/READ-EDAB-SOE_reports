...
## TODO: figure out how to have these conditional values dynamically assigned 
## when knitting the combined draft report for both regions
## thought I could reassign params$region and rerun this chunk, but that isn't possible
...
```{r, child = here::here("child_docs/child_plots.Rmd"), include = FALSE, eval = FALSE}
```
