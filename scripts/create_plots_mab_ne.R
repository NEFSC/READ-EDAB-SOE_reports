...
create_plots_mab_and_ne <- function(region) {
    ...
    plot_expression = {
      recreational_engagement_plot <- ecodata::plot_engagement(
        ...
        ggplot2::ggtitle(paste0(
          'Top Recreational Port Activity: ',
          region2,
          ' 2024'
        ))
    },
  ...
  save_plot(
    plot_expression = {
      ecodata::plot_trans_dates(report = region, varName = "length", n = 10) +
        ggplot2::ggtitle(paste0(
          'Time Between Spring and Fall Transition: ',
          region2
        ))
    },
  ...
  save_plot(
    ...
    width = 6.5,
    height = ifelse(region == "NewEngland", 7.5, 7)
  )
  ...
  save_plot(
    plot_expression = {
      if (region == 'MidAtlantic') {
        ...
        a = ecodata::plot_seasonal_oisst_anom(
          report = region,
          n = 10,
          EPU = 'GOM'
        ) +
          ggplot2::xlim(1982, 2026)
        b = ecodata::plot_seasonal_oisst_anom(
          report = region,
          n = 10,
          EPU = 'GB'
        ) +
  ...
  save_plot(
    plot_expression = {
      if (region == 'MidAtlantic') {
        ...
        a = ecodata::plot_bottom_temp_model_anom(
          report = region,
          n = 10,
          varName = "seasonal",
          EPU = "GOM",
          ...
          ggplot2::theme(legend.position = 'bottom')
        b = ecodata::plot_bottom_temp_model_anom(
          report = region,
          n = 10,
          varName = "seasonal",
          EPU = "GB",
