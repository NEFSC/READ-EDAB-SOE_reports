...
create_plots_mab_and_ne <- function(region) {
  ...
  save_plot(
    ...
    width = 6.5,
    height = ifelse(region == "NewEngland", 8.25, 2.75)
  )
  ...
  save_plot(
    ...
    indicator = "bennet",
    width = 6.5,
    height = ifelse(region == "NewEngland", 6.25, 2.75)
  )
  ...
  save_plot(
    ...
    width = ifelse(region == "NewEngland", 9.25, 4.25),
    height = 6.5
  )
    ...
    plot_expression = {
      if (region == "MidAtlantic") {
        ecodata::plot_annual_chl_pp(
          ...
          # ggplot2::coord_cartesian(ylim = c(2e+07, 4e+07)) +
  ...
  save_plot(
    ...
    indicator = "traits-tl",
    width = 6.5,
    height = ifelse(region == "NewEngland", 4.75, 2.75)
  )
  ...
  save_plot(
    ...
    indicator = "chl-month",
    width = 6.5,
    height = ifelse(region == "NewEngland", 7.25, 3.75)
  )
  ...
  save_plot(
    ...
    width = 6.5,
    height = ifelse(region == "NewEngland", 8.75, 7.75)
  )
  ...
  save_plot(
    ...
    width = 6.5,
    height = ifelse(region == "NewEngland", 7.25, 6.25)
  )
